...
#ifndef EMERALD
    #define OW_FLAG_POKE_RIDER          FLAG_0x0AF
#else
    #define OW_FLAG_POKE_RIDER          FLAG_UNUSED_0x020
#endif  // If this flag is set, the player will be able to use fly from the Pokenav Region Map and the Town Map key item by pressing 'R' on a city/location they are able to fly to.
