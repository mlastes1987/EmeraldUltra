...
#define GRASS_STARTER (IS_FRLG ? SPECIES_ROWLET : SPECIES_SPRIGATITO )
#define FIRE_STARTER  (IS_FRLG ? SPECIES_SCORBUNNY : SPECIES_CHIMCHAR )
#define WATER_STARTER (IS_FRLG ? SPECIES_TOTODILE : SPECIES_SOBBLE )
